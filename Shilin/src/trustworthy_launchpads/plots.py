"""Paper-ready figures for Shilin's artifacts."""
...
OBSOLETE_FIGURES = [
    "fig_l0_window_sensitivity_line_shilin.png",
    "fig_agentic_evaluation_bars_shilin.png",
]
...
def make_all_figures(
    ...
    plot_parallel_trends(config, config.figures_dir / "fig_parallel_trends_shilin.png")
    plot_event_study(event, config.figures_dir / "fig_event_study_shilin.png")
    plot_ladder(ladder, config.figures_dir / "fig_ablation_ladder_shilin.png")
    plot_frequency_sensitivity(frequency, config.figures_dir / "fig_frequency_sensitivity_shilin.png")
    plot_metric_status(battery, config.figures_dir / "fig_metric_battery_status_shilin.png")
    plot_external_validation_rpc(config, config.figures_dir / "fig_external_validation_rpc_shilin.png")
    plot_readiness_radar(config, config.figures_dir / "fig_readiness_radar_shilin.png")
    plot_readiness_status_bar(config, config.figures_dir / "fig_readiness_status_bar_shilin.png")
    plot_market_protocol_volume_lines(config, config.figures_dir / "fig_market_protocol_volume_lines_shilin.png")
    plot_agentic_method_omission_bar(config, config.figures_dir / "fig_agentic_method_omission_bar_shilin.png")
    plot_agentic_calibration_gap_bar(config, config.figures_dir / "fig_agentic_calibration_gap_bar_shilin.png")
    plot_h1_mechanism_audit(config, config.figures_dir / "fig_h1_mechanism_audit_shilin.png")
    plot_token_activity_distribution(config, config.figures_dir / "fig_token_activity_distribution_shilin.png")
    plot_frequency_market_single(frequency, config.figures_dir / "fig_frequency_market_twfe_single_shilin.png")
    plot_frequency_data_richness_single(frequency, config.figures_dir / "fig_frequency_data_richness_single_shilin.png")
    plot_rpc_active_share_single(config, config.figures_dir / "fig_rpc_active_share_single_shilin.png")
    plot_rpc_median_persistence_single(config, config.figures_dir / "fig_rpc_median_persistence_single_shilin.png")
    plot_rpc_token_distribution_single(config, config.figures_dir / "fig_rpc_token_distribution_single_shilin.png")
    plot_rpc_window_coverage_single(config, config.figures_dir / "fig_rpc_window_coverage_single_shilin.png")
    plot_h1_activity_placebo_single(config, config.figures_dir / "fig_h1_activity_placebo_single_shilin.png")
    plot_h1_persistence_intensity_single(config, config.figures_dir / "fig_h1_persistence_intensity_single_shilin.png")
    plot_h1_temporal_ordering_single(config, config.figures_dir / "fig_h1_temporal_ordering_single_shilin.png")
    plot_h1_claim_boundary_single(config, config.figures_dir / "fig_h1_claim_boundary_single_shilin.png")
    ...
    plot_agentic_scaffold_tradeoff(config, config.figures_dir / "fig_agentic_scaffold_tradeoff_shilin.png")
    plot_research_contribution_matrix(config, config.figures_dir / "fig_research_contribution_matrix_shilin.png")
