...
def summarize_collection(
    *,
    ...
    return {
        ...
        "claim_boundary": (
            "This is a decoded Moralis sample for Shilin H1/H4 measurement infrastructure. "
            "It strengthens token-level outcome measurement for covered tokens, but it is not by itself "
            "a full-cohort welfare causal estimate or Claire's cross-chain staggered DiD."
        ),
        "docs": {
