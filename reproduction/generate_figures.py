...
def make_event_study() -> None:
    ...
    clean_axes(ax)
    save(fig, "fig_event_study_application")
...
def make_ladder() -> None:
    ...
    save(fig, "fig_ladder_decision_flip_application")
...
def make_metric_battery() -> None:
    ...
    clean_axes(ax, grid_axis="x")
    save(fig, "fig_metric_battery_status_application")
...
def make_frequency() -> None:
    ...
    clean_axes(ax)
    save(fig, "fig_frequency_sensitivity_application")
...
def make_mechanism() -> None:
    ...
    clean_axes(ax, grid_axis="x")
    save(fig, "fig_h1_mechanism_audit_application")
...
def make_agentic() -> None:
    ...
    clean_axes(ax)
    save(fig, "fig_agentic_scaffold_tradeoff_application")
