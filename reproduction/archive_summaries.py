...
COPIES: list[tuple[str, str]] = [
    ...
    ("application/artifacts/agentic_v2/current/experiment_manifest.json", "application/agentic_v2/experiment_manifest.json"),
    ("application/artifacts/agentic_v2/current/condition_manifest.json", "application/agentic_v2/condition_manifest.json"),
    ("application/artifacts/agentic_v2/current/evidence_blocks.json", "application/agentic_v2/evidence_blocks.json"),
    ("application/artifacts/agentic_v2/current/run_registry.csv", "application/agentic_v2/run_registry.csv"),
    ("application/artifacts/agentic_v2/current/score_manifest.json", "application/agentic_v2/score_manifest.json"),
    ("application/artifacts/agentic_v2/current/call_scores.csv", "application/agentic_v2/call_scores.csv"),
    ("application/artifacts/agentic_v2/current/cell_scores.csv", "application/agentic_v2/cell_scores.csv"),
    ("application/artifacts/agentic_v2/current/canonical_deltas.csv", "application/agentic_v2/canonical_deltas.csv"),
    ("application/artifacts/agentic_v2/current/factorial_effects.csv", "application/agentic_v2/factorial_effects.csv"),
    ("application/artifacts/agentic_v2/current/control_comparisons.csv", "application/agentic_v2/control_comparisons.csv"),
    ("application/artifacts/agentic_v2/current/model_block_heterogeneity.csv", "application/agentic_v2/model_block_heterogeneity.csv"),
    ("application/artifacts/agentic_v2/current/model_factor_interactions.csv", "application/agentic_v2/model_factor_interactions.csv"),
    ("application/artifacts/agentic_v2/current/matched_factorial_pairs.csv", "application/agentic_v2/matched_factorial_pairs.csv"),
    ("application/artifacts/agentic_v2/current/matched_factorial_effects.csv", "application/agentic_v2/matched_factorial_effects.csv"),
    ("application/artifacts/telegram_replication/current/experiment_manifest.json", "application/telegram_replication/experiment_manifest.json"),
    ("application/artifacts/telegram_replication/current/condition_manifest.json", "application/telegram_replication/condition_manifest.json"),
    ("application/artifacts/telegram_replication/current/evidence_blocks.json", "application/telegram_replication/evidence_blocks.json"),
    ("application/artifacts/telegram_replication/current/run_registry.csv", "application/telegram_replication/run_registry.csv"),
    ("application/artifacts/telegram_replication/current/parsed_outputs.jsonl", "application/telegram_replication/parsed_outputs.jsonl"),
    ("application/artifacts/telegram_replication/current/call_scores.csv", "application/telegram_replication/call_scores.csv"),
    ("application/artifacts/telegram_replication/current/cell_scores.csv", "application/telegram_replication/cell_scores.csv"),
    ("application/artifacts/telegram_replication/current/condition_deltas.csv", "application/telegram_replication/condition_deltas.csv"),
    ("application/artifacts/telegram_replication/current/score_manifest.json", "application/telegram_replication/score_manifest.json"),
]
