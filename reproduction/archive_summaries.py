...
USER_PATH = re.compile(r"<local-home>/\s\"']+")
HOME_PATH = re.compile(r"<local-home>/\s\"']+")
...
COPIES: list[tuple[str, str]] = [
    ...
    ("application/artifacts/tables/event_study_coefficients_application.csv", "application/event_study_coefficients.csv"),
...
SOURCE_ALIASES = {"application": "application", "identification": "identification"}


def redact_text(text: str) -> str:
    text = USER_PATH.sub("<local-home>", text)
    text = HOME_PATH.sub("<local-home>", text)
    text = text.replace("pumpswap_application_application", "pumpswap_application")
    return text
