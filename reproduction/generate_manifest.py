...
ROWS = [
    ...
    },
    {
        ...
        "input": "reproduction/archived/application/deterministic_ladder.csv; telegram_mirror_design_summary.json; h1_rpc_mechanism_summary.json; identification/h0_summary.json; identification/h3_incidence.json; application/agentic_v2/run_registry.csv",
        "script": "reproduction/generate_tables.py",
    ...
    },
    {
        ...
        "script": "reproduction/build_teaser.py; reproduction/figures/teaser_figure_original.drawio.xml; reproduction/figures/teaser_figure_original.svg; reproduction/figures/teaser_figure_original.png; reproduction/figures/teaser_figure_print.html",
        "output": "paper/figs/teaser_figure_a4.pdf; paper/figs/teaser_figure_a4.svg; paper/figs/teaser_figure_a4.png; paper/figs/teaser_figure.pdf; paper/figs/teaser_figure.svg; paper/figs/teaser_figure.png",
    },
    {
    ...
    {
        "paper_object": "fig:appendix-agentic-v2-factor-effects",
        "object_type": "figure",
        "claim": "M4--M7 percentage-point main effects on unsafe causal affirmation and correct boundary across three models",
        "input": "reproduction/archived/application/agentic_v2/factorial_effects.csv",
        "script": "reproduction/generate_figures.py",
        "output": "paper/figs/fig_agentic_v2_factor_effects.pdf; paper/figs/fig_agentic_v2_factor_effects.svg; paper/figs/fig_agentic_v2_factor_effects.png",
    },
    {
        "paper_object": "legacy:fig-agentic-tradeoff",
        "object_type": "legacy_figure",
        "claim": "Legacy single-model pilot calibration-gap and method-omission artifact (not cited by the revised manuscript)",
    ...
    },
    {
        ...
        "object_type": "number",
        "claim": "714/714 calls; 160 factorial calls per model; heterogeneous model rates; pooled M6 effects and confidence intervals; L7 boundary outcomes",
        "input": "reproduction/archived/application/agentic_v2/run_registry.csv; call_scores.csv; factorial_effects.csv; score_manifest.json",
        "script": "application/scripts/run_agentic_v2.py; application/scripts/score_agentic_v2.py; application/scripts/verify_agentic_v2.py",
        "output": "paper/neurips_2026.tex",
    },
    {
    ...
    {
        "paper_object": "app:agent-v2",
        "object_type": "evaluation",
        "claim": "Fixed-design three-model blind audit; 714 parsed structured outputs and per-call scores; raw V2 provider responses excluded from the review archive",
        "input": "reproduction/archived/application/agentic_v2/experiment_manifest.json; condition_manifest.json; evidence_blocks.json; run_registry.csv; score_manifest.json; call_scores.csv; scientific summary tables",
        "script": "application/scripts/run_agentic_v2.py; application/scripts/score_agentic_v2.py; application/scripts/verify_agentic_v2.py",
        "output": "reproduction/archived/application/agentic_v2/",
    },
    {
        "paper_object": "legacy:agent-pilot",
        "object_type": "legacy_evaluation",
        "claim": "Historical DeepSeek pilot: 80 raw responses, 10 runs per rung, temperature 0; exact runtime payload not archived",
