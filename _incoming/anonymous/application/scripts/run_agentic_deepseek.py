#!/usr/bin/env python3
"""Run registered application agentic prompts with the DeepSeek chat API.
...
DEFAULT_ENV_PATH = Path("<local-home>/Desktop/SRS/02_Shanghai_Library_Project/StableTrade_Atlas_ODC-main/.env")
    ...
    if rung in {"L3", "L4"}:
        parts.extend(
            [
                ...
                artifact_table(
                    tables / "event_study_coefficients_application.csv",
                    rows=20,
