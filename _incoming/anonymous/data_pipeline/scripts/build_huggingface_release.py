...
def main() -> None:
    ...
    solana_bundle = repo / "data/external/application/20260810/bundle/01_Pumpfun_PumpSwap_Project/pumpfun_pumpswap_did_mvp_full_local/data/raw"
    for name in (
    ...
    delivered = repo / "data/external/application/20260810/bundle/Web3AI4IO/application/artifacts/external_validation"
    for name in (
