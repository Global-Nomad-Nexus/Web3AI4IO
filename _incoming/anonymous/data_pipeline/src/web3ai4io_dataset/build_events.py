...
def validate(repo: Path, events: list[dict[str, Any]], evidence: list[dict[str, Any]]) -> None:
    ...
    source_registry = json.loads((repo / "data_pipeline/source_registry.json").read_text(encoding="utf-8"))
...
def build(repo: Path) -> dict[str, Any]:
    registry_path = repo / "data_pipeline/events/v1/event_registry.json"
    evidence_path = repo / "data_pipeline/events/v1/event_evidence.json"
    ...
    manifest = repo / "data_pipeline/releases/v1/events_core.json"
