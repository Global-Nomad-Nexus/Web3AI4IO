...
identification's code for the Web3AI4IO project. Bulk data stay on Hugging Face. Internal Chinese plans and reports stay in the local workspace archive and are not part of this tree.

## Contents

* `src/web3io_identification/` rule-event analysis, registry helpers, and deterministic ladder checks
...
```text
PYTHONPATH=src python3 -m web3io_identification.analyze_h0
PYTHONPATH=src python3 -m web3io_identification.analyze_h3
PYTHONPATH=src python3 -m web3io_identification.crosscheck_ladder
