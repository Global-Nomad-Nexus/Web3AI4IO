...
BUNDLE = REPO_ROOT / "data/external/application/20260810/bundle"
...
CASE_JSON = BUNDLE / "Web3AI4IO/application/configs/pumpswap_case.json"
EVENTS_CSV = BUNDLE / "Web3AI4IO/application/benchmark_release/data/events.csv"
