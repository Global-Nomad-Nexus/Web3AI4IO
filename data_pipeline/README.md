...
1. Phase 1 builds the canonical application baseline and reproduces the RED PUMP cleaning path.
...
The decoded swap snapshot is validation data only. The project will preserve application's delivered state and will not collect additional decoded Solana swaps. See `SHILIN_LIMITATION.md`.
