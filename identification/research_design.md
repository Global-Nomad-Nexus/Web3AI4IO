...
The identification arm has two linked roles.
...
## Identification-arm deliverables mapped to the design
...
4. The independent identification-arm draft of Section 2.2 specifies the identification ladder, measurement axis, real world cases, and known truth calibration boundary.
