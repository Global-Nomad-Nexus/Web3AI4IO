...
def main() -> None:
    ...
    records = [
        record(
            ...
            path=application / "artifacts/external_validation/solana_post_migration_pool_windows.csv",
            unit="token_horizon",
        ...
        record(
            ...
            path=application / "artifacts/external_validation/moralis_decoded_token_outcomes.csv",
            unit="token_horizon",
            target_entities=1651,
            entity_column="mint",
        ...
        record(
            ...
            path=application / "artifacts/external_validation/dune_post_migration_trades.csv",
            unit="token_horizon",
            target_entities=1651,
            entity_column="mint",
            time_columns=("graduated_at", "first_trade_at", "last_trade_at"),
        ...
        record(
            ...
            path=application / "benchmark_release/data/covariates.csv",
            unit="token",
        ...
        record(
            ...
            path=ROOT / "identification/data_expansion/artifacts/pump_metadata_git_history.csv",
            unit="token",
            target_entities=1651,
            entity_column="mint",
        ...
        record(
            ...
            path=application / "artifacts/external_validation/clanker_base_token_created.csv",
        ...
        record(
            ...
            path=application / "artifacts/external_validation/clanker_base_token_horizons.csv",
            unit="token_horizon",
        ...
        record(
            ...
            path=application / "benchmark_release/data/clanker_base_full_cohort_manifest.csv",
            unit="token",
            target_entities=13880,
            entity_column="token_id",
        ...
        record(
            ...
            path=ROOT / "identification/data_expansion/artifacts/base_pilot_coverage.csv",
            unit="token_log_type",
            target_entities=13880,
            entity_column="token_id",
            time_columns=(),
        ...
        record(
            ...
            path=ROOT / "identification/data_expansion/artifacts/base_pilot_treated_coverage.csv",
            unit="token_log_type",
