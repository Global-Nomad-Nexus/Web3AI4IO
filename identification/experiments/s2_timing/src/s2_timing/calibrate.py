...
CLAIRE_ROOT = EXPERIMENT_ROOT.parents[1]

PANEL = CLAIRE_ROOT / "data" / "pump_moonshot_cohort_panel.csv"
REGISTRY = CLAIRE_ROOT / "event_registry.csv"
EVIDENCE = CLAIRE_ROOT / "event_activation_evidence.md"
CONTRACT = CLAIRE_ROOT / "data_contract.md"
...
def main() -> int:
    ...
    manifest = {
        ...
        "inputs": {
            str(p.relative_to(CLAIRE_ROOT)): {"sha256": sha256(p)}
