...
`Web3AI4IO/identification/experiment_plans/S1_staggered_heterogeneous_effects.md`.
...
- Shared-environment modification: none — all writes under
  `identification/experiments/s1_staggered/`; dependencies installed only in the
