...
Design-locked spec: `Web3AI4IO/identification/experiment_plans/S1_staggered_heterogeneous_effects.md`.
...
- `dataset/releases/v1/base_core.json`
...
From `Web3AI4IO/identification/experiments/s1_staggered/`:
