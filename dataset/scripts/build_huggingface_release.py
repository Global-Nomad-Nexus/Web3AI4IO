...
def main() -> None:
    ...
    solana_bundle = repo / "data/external/pumpswap/20260810/bundle/01_Pumpfun_PumpSwap_Project/pumpfun_pumpswap_did_mvp_full_local/data/raw"
    for name in (
    ...
    delivered = repo / "data/external/pumpswap/20260810/bundle/Web3AI4IO/application/artifacts/external_validation"
    for name in (
    ...
    for path in (
        ...
        repo / "dataset/schemas/v1/event_schema_registry.json",
        repo / "dataset/events/v1/event_registry.json",
        repo / "dataset/events/v1/event_evidence.json",
        ...
        repo / "dataset/releases/v1/events_core.json",
