...
1. Phase 1 builds the canonical Solana application baseline and reproduces the RED PUMP cleaning path.
...
The decoded swap snapshot is validation data only. The delivered Moralis state is preserved; additional decoded Solana swaps will not be collected. See `decoded_swap_limitation.md`.
