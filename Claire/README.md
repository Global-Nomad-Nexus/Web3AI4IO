...
The verified contribution is integrated into the active shared manuscript `../manuscript/neurips_2026.tex` in the research workspace. It contains the related-work strand, H0, H3, Method Pillar 3, the independent benchmark design, Result 2, sequential-event handling, the naive rerun, and the rule-event L0 through L7 ladder. The superseded standalone source, its last compiled PDF, internal reports, and historical audits are preserved in the workspace-level `../notes/` folder beside `records/`.
