...
Spec (authoritative): `Web3AI4IO/Claire/experiment_plans/S3_few_platform_clusters.md`,
including the 2026-08-13 scale-rule revision (修订记录). Status: **RUN COMPLETE**.

## Input data and evidence metadata

- Panel: `Web3AI4IO/data/external/shilin/20260810/bundle/01_Pumpfun_PumpSwap_Project/pumpfun_pumpswap_did_mvp_full_local/data/processed/solana_dex_daily_did_panel.csv`,
...
- Event config `.../Shilin/configs/pumpswap_case.json` and registry
...
```bash
cd Web3AI4IO/Claire/experiments/s3_few_clusters
