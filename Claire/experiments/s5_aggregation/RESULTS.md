...
4. 2026-08-14 **研究者批准修订**:primary controls = raydium + orca;Claire 侧 corrected panel;missing-data policy;Meteora 仅限 restricted-window sensitivity;删除 effect gate;三臂设计;SD_null 预锁定。S3 单独 blocker:`Claire/experiment_plans/S3_meteora_coverage_blocker.md`。
