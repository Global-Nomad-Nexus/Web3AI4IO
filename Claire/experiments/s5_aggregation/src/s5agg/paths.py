...
* Analysis panel = Claire-side derived corrected panel; the immutable
...
EVIDENCE_FILES = [
    BUNDLE / "Web3AI4IO/Shilin/configs/pumpswap_case.json",
    BUNDLE / "Web3AI4IO/Shilin/benchmark_release/data/events.csv",
]
