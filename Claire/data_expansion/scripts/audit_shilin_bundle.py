#!/usr/bin/env python3
"""Audit the immutable Shilin reproducibility bundle without running models."""
...
BUNDLE = ROOT / "data/external/shilin/20260810/bundle"
UPSTREAM = BUNDLE / "01_Pumpfun_PumpSwap_Project/pumpfun_pumpswap_did_mvp_full_local"
SHILIN = BUNDLE / "Web3AI4IO/Shilin"
OUT = ROOT / "Claire/data_expansion/artifacts/shilin_bundle_audit.json"
