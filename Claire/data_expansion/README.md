...
1. Preserve Shilin's decoded Solana outcomes as validation data only. Do not continue decoded swap collection.
...
```text
python3 Claire/data_expansion/scripts/audit_coverage.py
```
