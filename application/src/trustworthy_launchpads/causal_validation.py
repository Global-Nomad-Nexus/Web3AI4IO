...
def build_teacher_requirements_alignment(config: CaseConfig, mechanism_summary: dict[str, object]) -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "status": "added_to_application_report_needs_joint_paper_sync",
        ...
        },
        {
            ...
            "teacher_requirement": "Provide revised dataset specification, cross-chain extension, application mirror case ladder, AI-for-good framing, artifact outline, and remaining blockers.",
            "artifact": str(config.project_root / "SHILIN-AUGUST7-REVISION-PLAN.md"),
            "status": "application_side_release_candidate_with_blockers",
            "evidence_or_gap": "application-side artifacts are concrete; identification semi-synthetic suite and joint paper integration remain outside this application-only audit.",
        },
        {
            "ownership_item": "H1 migration friction / post-graduation persistence",
            "teacher_requirement": "application owns H1 and Result 1 mechanism evidence.",
        ...
        },
        {
            ...
            "teacher_requirement": "application owns H4; H2 is joint.",
        ...
        },
        {
            ...
            "teacher_requirement": "Put code, data, and artifacts under application's folder.",
    ...
    write_csv(tables / "teacher_requirements_alignment_application.csv", alignment)
    return alignment
