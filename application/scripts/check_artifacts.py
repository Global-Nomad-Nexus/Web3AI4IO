...
REQUIRED_FIGURES = [
    "fig_parallel_trends.png",
    "fig_event_study.png",
    "fig_ablation_ladder.png",
    "fig_frequency_sensitivity.png",
    "fig_metric_battery_status.png",
    "fig_external_validation_rpc.png",
    "fig_readiness_radar.png",
    "fig_readiness_status_bar.png",
    "fig_market_protocol_volume_lines.png",
    "fig_agentic_method_omission_bar.png",
    "fig_agentic_calibration_gap_bar.png",
    "fig_h1_mechanism_audit.png",
    "fig_token_activity_distribution.png",
    "fig_frequency_market_twfe_single.png",
    "fig_frequency_data_richness_single.png",
    "fig_rpc_active_share_single.png",
    "fig_rpc_median_persistence_single.png",
    "fig_rpc_token_distribution_single.png",
    "fig_rpc_window_coverage_single.png",
    "fig_h1_activity_placebo_single.png",
    "fig_h1_persistence_intensity_single.png",
    "fig_h1_temporal_ordering_single.png",
    "fig_h1_claim_boundary_single.png",
    "fig_token_coverage_by_date_single.png",
    "fig_token_persistence_survival_single.png",
    "fig_ladder_decision_flip.png",
    "fig_paired_case_ladder.png",
    "fig_rpc_deepening_gain.png",
    "fig_horizon_ridgeline.png",
    "fig_readiness_gap_heatmap.png",
    "fig_agentic_scaffold_tradeoff.png",
    "fig_research_contribution_matrix.png",
]
