#!/usr/bin/env python3
"""Lightweight verification for generated application artifacts."""
...
REQUIRED_TABLES = [
    ...
    "event_study_coefficients_application.csv",
...
REQUIRED_FIGURES = [
    "fig_parallel_trends_application.png",
    "fig_event_study_application.png",
    "fig_ablation_ladder_application.png",
    "fig_frequency_sensitivity_application.png",
    "fig_metric_battery_status_application.png",
    "fig_external_validation_rpc_application.png",
    "fig_readiness_radar_application.png",
    "fig_readiness_status_bar_application.png",
    "fig_market_protocol_volume_lines_application.png",
    "fig_agentic_method_omission_bar_application.png",
    "fig_agentic_calibration_gap_bar_application.png",
    "fig_h1_mechanism_audit_application.png",
    "fig_token_activity_distribution_application.png",
    "fig_frequency_market_twfe_single_application.png",
    "fig_frequency_data_richness_single_application.png",
    "fig_rpc_active_share_single_application.png",
    "fig_rpc_median_persistence_single_application.png",
    "fig_rpc_token_distribution_single_application.png",
    "fig_rpc_window_coverage_single_application.png",
    "fig_h1_activity_placebo_single_application.png",
    "fig_h1_persistence_intensity_single_application.png",
    "fig_h1_temporal_ordering_single_application.png",
    "fig_h1_claim_boundary_single_application.png",
    "fig_token_coverage_by_date_single_application.png",
    "fig_token_persistence_survival_single_application.png",
    "fig_ladder_decision_flip_application.png",
    "fig_paired_case_ladder_application.png",
    "fig_rpc_deepening_gain_application.png",
    "fig_horizon_ridgeline_application.png",
    "fig_readiness_gap_heatmap_application.png",
    "fig_agentic_scaffold_tradeoff_application.png",
    "fig_research_contribution_matrix_application.png",
]
...
def main() -> None:
    ...
    if errors:
        ...
        for error in errors:
            print(f"  - {error}")
        raise SystemExit(1)
    print("All required application artifacts exist and are non-empty.")
