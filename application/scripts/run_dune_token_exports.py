#!/usr/bin/env python3
"""Render or execute full token-level Dune exports for application H1/H4.
    ...
    *,
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "applicationResearchBot/0.1",
        },
    )
    try:
...
def download_csv(
    ...
    *,
    ...
    request = urllib.request.Request(
        url,
        method="GET",
        headers={"X-Dune-Api-Key": api_key, "User-Agent": "applicationResearchBot/0.1"},
    )
    try:
        with urllib.request.urlopen(request, timeout=timeout) as response:
